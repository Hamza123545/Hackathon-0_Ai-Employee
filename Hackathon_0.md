...
If the Zoom meeting is full, you may watch live or recording at: [YouTube Channel](https://www.youtube.com/@panaversity)
...
- [Claude Code just Built me an AI Agent Team (Claude Code + Skills + MCP)](https://www.youtube.com/watch?v=0J2_YGuNrDo)
...
| Claude Code Fundamentals | [Textbook Chapter](https://agentfactory.panaversity.org/docs/AI-Tool-Landscape/claude-code-features-and-workflows) | 3 hours |
| Obsidian Fundamentals | [Getting Started](https://help.obsidian.md/Getting+started) | 30 min |
...
| Agent Skills | [Claude Platform Docs](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) | 2 hours |
...
| Topic | Resource | Type |
|-------|----------|------|
| Claude + Obsidian Integration | [YouTube Video](https://www.youtube.com/watch?v=sCIS05Qt79Y) | Video |
| Building MCP Servers | [MCP Quickstart](https://modelcontextprotocol.io/quickstart) | Tutorial |
| Claude Agent Teams | [YouTube Video](https://www.youtube.com/watch?v=0J2_YGuNrDo) | Video |
...
[Advanced Custom Cloud FTE Architecture](https://docs.google.com/document/d/15GuwZwIOQy_g1XsIJjQsFNHCTQTWoXQhWGVMhiH0swc/edit?usp=sharing) 